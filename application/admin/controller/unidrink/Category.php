...
use app\admin\model\unidrink\Category as CategoryModel;
use fast\Tree;
use think\Db;
...
class Category extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $tree = Tree::instance();
        $tree->init(collection($this->model->whereIn('shop_id', array_keys($this->shopData))->order('weigh asc,id desc')->select())->toArray(), 'pid');
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                if ($params['pid'] != $row['pid']) {
                    $childrenIds = Tree::instance()->init(collection(\app\admin\model\unidrink\Category::select())->toArray())->getChildrenIds($row['id']);
