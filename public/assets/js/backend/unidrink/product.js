...
define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'upload', 'vue'], function ($, undefined, Backend, Table, Form, Upload, Vue) {
    ...
    var specComponent = Vue.extend({
        ...
        computed: {
            ...
            noSpecValue() {
                if (this.specTableList.length > 0 && this.use_spec == 1) {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'category_id', title: __('Category_id'), visible: false, searchList: Config.categoryList},
                        {
                            field: 'category', title: __('Category name'), operate:false, formatter: function (value, row, index) {
                                if (value) {
                                    if (value.parent) {
                        ...
                        {field: 'switch', title: __('Switch'), formatter: Table.api.formatter.toggle,searchList: {"0":__('下架'),"1":__('上架')}},
                        {field: 'no_buy_yet', title: '下单未支付', operate: false},
